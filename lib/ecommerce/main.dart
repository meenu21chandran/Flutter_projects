                ...
                child: Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(image: AssetImage("assets/images/cards.jpg"),
                            fit: BoxFit.cover)
                    ),
                    child:Column(
                  ...
                  child:Container(
                      ...
                      child: ListView(
                          ...
                          children:[  Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              image: const DecorationImage(image: AssetImage("assets/images/bags.jpg"),
                                  fit: BoxFit.fill),
                            ),
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  const Padding(padding: EdgeInsets.all(20),
                                    child:Text("Bag Collections",
                                      style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black),),),
                                  const Padding(padding: EdgeInsets.all(20),
                                    child:Text("15 Brands",style: TextStyle(color: Colors.black,fontSize: 15),),),
                                ]),
                          ),
                            const Padding(padding: EdgeInsets.only(left: 10)),
                            Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20),
                                image: const DecorationImage(image: AssetImage("assets/images/sandals.jpg"),
                                    fit: BoxFit.fill),
                              ),
                              child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(image: AssetImage("assets/images/girly things.jpg"),
                              fit: BoxFit.fill,)
                        ),
                      ),
                      const Padding(padding: EdgeInsets.only(left: 10)),
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            image: const DecorationImage(image: AssetImage("assets/images/electronics.jpg"),
                              fit: BoxFit.fill,)
                        ),
                      ),
                      const Padding(padding: EdgeInsets.only(left: 10)),
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            image: const DecorationImage(image: AssetImage("assets/images/home aplliances.jpg"),
                              fit: BoxFit.fill,)
                        ),
                      ),
                      const Padding(padding: EdgeInsets.only(left: 10)),
