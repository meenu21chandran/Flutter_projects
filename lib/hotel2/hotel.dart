                            ...
                            children: [
                              ...
                              Padding(padding: const EdgeInsets.only(top: 20,left: 15),
                                child:   Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text("Awesome room near Thrissur",style: TextStyle(fontWeight: FontWeight.bold,
                                        fontSize: 20),),
                                    const Text("Thrissur,Kerala",style: TextStyle(fontSize: 15),),
